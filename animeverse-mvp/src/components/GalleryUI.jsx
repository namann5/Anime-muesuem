...
export default function GalleryUI({
  ...
  const handleBgToggle = () =>
    onBackgroundToggle && onBackgroundToggle(!envBackground);

  return (
    <div
      className="gallery-ui-overlay"
      role="toolbar"
    ...
    >
      ...
      <div className="preset-group" style={{ marginLeft: 12 }}>
        <button
          className="btn"
          onClick={() => onPresetChange && onPresetChange("studio")}
        >
          <svg viewBox="0 0 24 24" aria-hidden="true">
        ...
        <button
          className="btn"
          onClick={() => onPresetChange && onPresetChange("city")}
        >
          <svg viewBox="0 0 24 24" aria-hidden="true">
        ...
        <button
          className="btn"
          onClick={() => onPresetChange && onPresetChange("none")}
        >
          None
        </button>
        <button
