...
export default function EnvironmentLoader({ preset = 'studio', background = false }) {
  const [files, setFiles] = useState(null)

  useEffect(() => {
    const map = {
      studio: 'https://dl.polyhaven.org/file/ph-assets/HDRIs/hdr/2k/studio_small_02_2k.hdr',
