      ...
      <div className="container mx-auto px-6 relative z-10 support-content">
        <div className="text-center mb-16">
          ...
          <p className="max-w-xl mx-auto text-white/50 text-lg">
            Your support keeps the servers running and helps us bring more
            immersive anime experiences to life.
          </p>
        </div>
        ...
        <div className="max-w-md mx-auto">
          ...
          <div className="grid grid-cols-3 gap-4 mb-12">
            {["₹49", "₹99", "₹199"].map((amt) => (
              ...
              >
                <span className="text-xl font-black group-hover:text-pink-400 transition-colors">
                  {amt}
                </span>
              </button>
            ))}
          ...
          <div className="glass-card-modern p-6 rounded-2xl border border-white/10 text-center">
            <p className="text-sm text-white/40 leading-relaxed">
              All contributions directly support development, hosting, and
              future features. Thank you for believing in our vision.
            </p>
          </div>
        </div>
      </div>
