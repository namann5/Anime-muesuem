...
export default function WatchAnime() {
  ...
  if (loading)
    return (
      <div className="min-h-screen bg-[#050505] flex flex-col items-center justify-center">
        ...
        <div className="mt-4 text-[10px] font-black tracking-widest uppercase text-pink-500">
          Initializing Cinema
        </div>
      </div>
    );
  ...
  return (
    <div
      ref={containerRef}
      className="min-h-screen bg-[#050505] pb-20 mesh-gradient-modern selection:bg-pink-500/30"
    >
      {/* Immersive Hero */}
      {heroAnime && (
        <section className="relative h-[60vh] md:h-screen w-full overflow-hidden">
          ...
          <div className="absolute inset-0 z-10 container mx-auto px-4 md:px-6 flex flex-col justify-center items-start pt-12 md:pt-20 watch-fade-in">
            ...
            <h1 className="text-3xl sm:text-5xl md:text-9xl font-black mb-6 leading-none tracking-tighter italic">
    ...
    >
      <div className="aspect-[16/9] relative glass-card-modern rounded-2xl overflow-hidden mb-4 border-white/5 group-hover:border-pink-500/30 transition-all shadow-xl">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity p-4 sm:p-6 flex flex-col justify-end">
          ...
          <h3 className="font-bold text-white text-xs sm:text-sm md:text-sm leading-tight line-clamp-2">
