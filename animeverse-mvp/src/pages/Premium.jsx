...
export default function Premium() {
  ...
  return (
    <div className="min-h-screen pt-32 pb-20 px-6 mesh-gradient-modern">
      ...
      <div className="relative z-10 max-w-5xl mx-auto">
        <div className="text-center mb-16">
          ...
          <h1 className="text-5xl md:text-7xl font-black leading-tight mb-6 bg-gradient-to-r from-violet-400 via-pink-400 to-amber-400 bg-clip-text text-transparent">
            GO PREMIUM
          </h1>
          <p className="text-lg text-white/50 max-w-xl mx-auto">
            Experience anime like never before with exclusive content, ad-free streaming, and premium features.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          {Object.entries(plans).map(([key, plan]) => (
            <div
              ...
              className={`relative glass-card-modern p-8 rounded-3xl cursor-pointer transition-all duration-300 ${
                selectedPlan === key 
        ...
        <div className="glass-card-modern p-8 rounded-3xl max-w-md mx-auto">
          <div className="mb-6">
          ...
          <button
            ...
            disabled={loading}
            className="w-full py-4 bg-gradient-to-r from-violet-600 to-pink-600 hover:from-violet-500 hover:to-pink-500 rounded-xl font-bold text-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
          >
            {loading ? (
              <>
        ...
        <div className="mt-16 text-center">
          <p className="text-white/30 text-sm">
            Questions? <a href="#" className="text-violet-400 hover:underline">Contact support</a>
          </p>
        </div>
      </div>
    </div>
