      ...
      <div className="relative z-10 text-center max-w-lg">
        ...
        {status === 'success' && (
          <>
            ...
            <p className="text-lg text-white/60 mb-8">
              Your subscription is now active. Enjoy ad-free streaming and exclusive content!
            </p>
            
            {sessionData && (
              <div className="glass-card-modern p-6 rounded-2xl mb-8 text-left">
                <h3 className="font-bold text-sm text-white/40 uppercase tracking-wider mb-4">Order Details</h3>
        ...
        {status === 'pending' && (
          <>
            ...
            <h1 className="text-4xl font-bold mb-4 text-amber-400">Payment Processing</h1>
            <p className="text-lg text-white/60 mb-8">
        ...
        {status === 'error' && (
          <>
            ...
            <h1 className="text-4xl font-bold mb-4 text-red-400">Verification Failed</h1>
            <p className="text-lg text-white/60 mb-8">
