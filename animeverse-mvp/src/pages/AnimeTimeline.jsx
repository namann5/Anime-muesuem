    ...
    >
      ...
      <header className="relative z-10 container mx-auto px-6 pt-24 pb-16 text-center">
        ...
        <p className="text-2xl text-white/80 max-w-4xl mx-auto mb-4 animate-fade-in-up animation-delay-200">
          Journey through{" "}
          <span className="text-pink-400 font-bold">50+ years</span> of
          animation evolution
        </p>
              ...
              return (
                <button
                  ...
                  className={`
                                        ...
                                        ${
                                          isActive
                                            ? `neon-border ${colors.glow} scale-110`
                                            : "glass-card-3d"
                                        }
                                        ${
                                          index % 2 === 0
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <div
                      className={`text-xs bg-gradient-to-r ${colors.gradient} bg-clip-text text-transparent`}
                    >
                      {stats.shows} Shows
                    </div>
                  </div>
                  ...
                  {/* Hover glow */}
                  <div
                    className={`absolute inset-0 bg-gradient-to-r ${colors.gradient} opacity-0 group-hover:opacity-20 transition-opacity`}
                  ></div>
                </button>
              );
            })}
            ...
            return (
              ...
              >
                ...
                <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 hidden md:block">
                  <div
                    className={`w-8 h-8 rounded-full ${colors.glow} neon-border animate-pulse`}
                  ></div>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-12 items-center">
                  ...
                  >
                    {/* Main Card */}
                    <div
                      className={`card-3d perspective-2000 preserve-3d glass-card-3d holographic p-8 rounded-3xl ${colors.glow} liquid`}
                    >
                      <div className="card-3d-inner space-y-6">
                        {/* Era Badge */}
                        <div className="flex items-center gap-4">
                          <div
                            className={`neon-border px-6 py-3 rounded-full ${colors.glow} float-slow`}
                          >
                        ...
                        {/* Title */}
                        <h2
                          className={`text-5xl font-black bg-gradient-to-r ${colors.gradient} bg-clip-text text-transparent depth-layer-2`}
                        >
                          {era.title}
                        </h2>
                        ...
                        <div className="grid grid-cols-2 gap-4 pt-4">
                          <div
                            className={`glass-card-3d p-4 rounded-xl ${colors.glow} text-center`}
                          >
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div
                        className={`glass-card-3d holographic p-4 rounded-xl ${colors.glow} float-slow`}
                      >
                      ...
                      <div
                        className={`glass-card-3d holographic p-4 rounded-xl ${colors.glow} float-medium`}
                      >
                        <div className="text-2xl mb-2">📡</div>
                        <div className="text-white font-bold text-sm">
                          Distribution
                  ...
                  >
                    <div
                      className={`card-3d perspective-2000 preserve-3d glass-card-3d holographic p-6 rounded-3xl ${
                        colors.glow
                    ...
                    >
                      <div className="card-3d-inner relative aspect-video rounded-2xl overflow-hidden">
                        ...
                        <div className="relative w-full h-full bg-gradient-to-br from-slate-900 to-slate-800">
                          ...
                          <div className="absolute top-4 left-4 glass-card-3d px-4 py-2 rounded-full glow-ring">
                            <div className="flex items-center gap-2">
                              <div
                                className={`w-2 h-2 ${
                                  era.videoId ? "bg-red-500" : "bg-blue-500"
                        ...
                        {/* Frame decoration */}
                        <div
                          className={`absolute inset-0 border-4 border-transparent bg-gradient-to-r ${colors.gradient} opacity-0 hover:opacity-50 transition-opacity rounded-2xl`}
                          style={{
                            padding: "2px",
                            WebkitMask:
        ...
        <div className="card-3d perspective-2000 preserve-3d glass-card-3d holographic glow-pink p-16 rounded-3xl text-center neon-border liquid">
          <div className="card-3d-inner space-y-6">
            ...
            <p className="text-white/80 text-xl mb-8 max-w-3xl mx-auto">
              Visit our{" "}
              <span className="text-pink-400 font-bold">Virtual Museum</span> to
              see iconic characters from each era in stunning 3D
            </p>
            <div className="flex flex-wrap justify-center gap-4">
