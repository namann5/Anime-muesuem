        ...
        <div className="glass-card-modern p-6 rounded-2xl mb-8">
          ...
          <ul className="text-left text-sm text-white/50 space-y-2">
            <li className="flex items-center gap-2">
              <span className="text-violet-400">✓</span> Ad-free streaming experience
            </li>
            <li className="flex items-center gap-2">
              <span className="text-violet-400">✓</span> HD & 4K video quality
            </li>
            <li className="flex items-center gap-2">
              <span className="text-violet-400">✓</span> Early access to new releases
            </li>
            <li className="flex items-center gap-2">
              <span className="text-violet-400">✓</span> Exclusive premium content
            </li>
          </ul>
        </div>
